...
tower_locations = pd.read_csv(join(abspath(dirname(__file__)), "2024-08-02_tower_long_list.csv"))
...
calval_df.to_csv("/project/sandbox/ECOv002_L3T_L4T/2024-09-08_ECOSTRESS_calval_C1_C2.csv")
