...
product_directory = "/project/sandbox/ECOv002_L3T_L4T/output_calval"

tower_locations = pd.read_csv("tile_list_LE_val_sites.csv")
...
df.to_csv("/project/sandbox/ECOv002_L3T_L4T/calval.csv")
